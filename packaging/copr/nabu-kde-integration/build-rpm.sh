...
install -m0755 "${files_dir}/nabu-kde-auto-brightness-guard" \
    "$source_root/kde/nabu-kde-auto-brightness-guard"
...
install -m0644 "${files_dir}/nabu-kde-auto-brightness-guard.service" \
    "$source_root/kde/nabu-kde-auto-brightness-guard.service"
