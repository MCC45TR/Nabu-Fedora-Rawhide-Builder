...
grep -Fxq 'default senemos.conf' "$esp/loader/loader.conf"
grep -Fxq 'efi /EFI/fedora/SENEMOS6-2608291500.efi' "$esp/loader/entries/senemos.conf"
...
grep -Fxq 'timeout 1' "$esp/EFI/BOOT/refind.conf"
...
! grep -q '^menuentry ' "$esp/EFI/BOOT/refind.conf"
