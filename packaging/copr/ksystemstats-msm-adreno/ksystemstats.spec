Name:           ksystemstats-nabu
Version:        6.7.4
Release:        2.nabu2%{?dist}
...
Source0:        https://download.kde.org/stable/plasma/%{version}/ksystemstats-%{version}.tar.xz
Patch0:         0001-gpu-add-Linux-MSM-Adreno-sensors.patch

Provides:       ksystemstats%{?_isa} = %{version}-%{release}
Provides:       ksystemstats = %{version}-%{release}
Obsoletes:      ksystemstats < %{version}-%{release}
...
%prep
%autosetup -n ksystemstats-%{version} -p1
...
%changelog
* Sat Sep 05 2026 MCC45TR <mcc45tr@gmail.com> - 6.7.4-2.nabu2
