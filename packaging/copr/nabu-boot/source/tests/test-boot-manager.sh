...
printf 'mainline\n' >"$esp/EFI/SENEMOS/SENEMOS7-7.2.3.efi"
printf 'old-mainline\n' >"$esp/EFI/SENEMOS/SENEMOS7-2608270000.efi"
printf 'old-mainline-semantic\n' >"$esp/EFI/SENEMOS/SENEMOS7-7.2.2.efi"
...
grep -Fxq 'efi /EFI/fedora/SENEMOS7-7.2.3.efi' "$esp/loader/entries/senemos-SENEMOS7.conf"
...
! grep -Eq '^scanfor (internal|external|optical|netboot|firmware)' "$esp/EFI/BOOT/refind.conf"
...
grep -Fxq 'menuentry "Reboot to Android" {' "$esp/EFI/BOOT/refind.conf"
grep -Fxq '    loader /EFI/fedora/SENEMOS7-7.2.3.efi' "$esp/EFI/BOOT/refind.conf"
grep -Fxq '    loader /EFI/android/Reboot2Android.efi' "$esp/EFI/BOOT/refind.conf"
