...
Source1:        senemos-nabu-plymouth-1.0.0.tar.zst
...
%package -n senemos-nabu-plymouth
...
%description -n senemos-nabu-plymouth
...
%build
pushd senemos-nabu-plymouth-1.0.0
...
test "$(identify -format '%%wx%%h' senemos-nabu-plymouth-1.0.0/fedora-logo.png)" = 427x120
test "$(identify -format '%%wx%%h' senemos-nabu-plymouth-1.0.0/xiaomi-logo.png)" = 312x312
grep -Fq 'screen_height - fedora.image.GetHeight() - 40' \
    senemos-nabu-plymouth-1.0.0/senemos-nabu.script
...
install -m0644 \
    senemos-nabu-plymouth-1.0.0/senemos-nabu.plymouth \
    senemos-nabu-plymouth-1.0.0/senemos-nabu.script \
    senemos-nabu-plymouth-1.0.0/Fedora_logo.svg \
    senemos-nabu-plymouth-1.0.0/Xiaomi_logo.svg \
    senemos-nabu-plymouth-1.0.0/fedora-logo.png \
    senemos-nabu-plymouth-1.0.0/xiaomi-logo.png \
    senemos-nabu-plymouth-1.0.0/progress-track.png \
    senemos-nabu-plymouth-1.0.0/progress-cap.png \
    senemos-nabu-plymouth-1.0.0/progress-center.png \
    "$theme_dir"/

%post -n senemos-nabu-plymouth
...
%posttrans -n senemos-nabu-plymouth -p /usr/bin/bash
...
- Keep update convergence at one UKI per family and test exact manual entries.
