...
%changelog
* Fri Sep 04 2026 mcc45tr <mcc45tr@gmail.com> - 51~rc-1.nabu1
- Rebase to GNOME 51.rc so auto-rotation can claim the accelerometer reliably.
- Carry the upstream orientation inhibit-state fix merged for Mutter 51.
