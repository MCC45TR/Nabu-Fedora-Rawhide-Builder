...
Source1:        80-nabu-plasma-login-theme.conf
Source2:        nabu-plasma-login.svg
BuildArch:      noarch
...
install -Dm0644 %{SOURCE1} %{buildroot}%{_prefix}/lib/plasmalogin/plasmalogin.conf.d/80-nabu-plasma-login-theme.conf
install -Dm0644 %{SOURCE2} %{buildroot}%{_datadir}/backgrounds/nabu/nabu-plasma-login.svg
