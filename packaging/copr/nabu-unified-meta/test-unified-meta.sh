...
grep -Fq '[stable]=SENEMOS6' "$root/nabu-kernel-maintenance" || fail "stable EFI family mapping missing"
grep -Fq '[mainline]=SENEMOS7' "$root/nabu-kernel-maintenance" || fail "mainline EFI family mapping missing"
grep -Fq '[lts]=SENEMOS6LTS' "$root/nabu-kernel-maintenance" || fail "LTS EFI family mapping missing"
